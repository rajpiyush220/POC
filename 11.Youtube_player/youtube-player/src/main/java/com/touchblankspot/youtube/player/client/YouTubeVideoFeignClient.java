...
public interface YouTubeVideoFeignClient {
	...
	VideoResponse search(@RequestParam(value = "key") String key, @RequestParam(value = "channelId") String channelId,
			@RequestParam(value = "part") String part, @RequestParam(value = "order") String order,
			@RequestParam(value = "type") String type, @RequestParam(value = "maxResults") Integer maxResults);

	@RequestMapping(method = RequestMethod.GET, value = "/search")
	VideoResponse searchAfterDate(@RequestParam(value = "key") String key,
			@RequestParam(value = "channelId") String channelId, @RequestParam(value = "part") String part,
			@RequestParam(value = "publishedAfter") String publishedAfter, @RequestParam(value = "type") String type);
